...
const goToMantaRobotic = () => {
  router.push({ name: 'manta-robotic' })
  isMenuOpen.value = false
}
</script>
  ...
  <nav class="navbar">
    <div class="nav-container">
      ...
      <div class="nav-links" :class="{ 'nav-active': isMenuOpen }">
        ...
        <div class="nav-item highlight" @click="goToMantaRobotic">
          MantaRobotic
        </div>
        <a href="/assets/HAN Haolin's CV.pdf" target="_blank" class="nav-item cv-button">
